...
<section>
  <p class="description">
    <span class="sr-only">The Pudding</span> is a digital publication that explains ideas debated in
  ...
  <div class="ctas">
    <div class="button-wrapper">
      ...
      >
      <a class="btn" href="https://www.patreon.com/thepudding">Support us on Patreon</a>
    </div>
